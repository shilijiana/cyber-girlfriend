...
| CC-04 | H6 路径校验修复（真实生产缺陷） | P1 | ✅ | `file-persona-provider.ts` resolveIdDir 校验规范化 base（2026-08-11 完成：`startsWith(resolve(personasDir))` + 大小写归一；实测 getPersona 生产路径通过、越界仍拦截、M-P 9/9 + tsc + ws-smoke 6/6） | 修复 commit 见本次提交 |
